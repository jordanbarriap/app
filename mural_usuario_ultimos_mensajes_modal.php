...
if ($_mensajes==null){
    ...
    $id_ultimo_mensaje = -1;
        ...
        $id_ultimo_mensaje = $_mensajes[0]["id_mensaje"];
        while($_mensajes[$i]) {
            ...
            $usuario_gusta_mensaje = dbMuralUsuarioGustaMensaje($_SESSION["klwn_id_usuario"], $id_mensaje_actual, $conexion);
                ...
                <div  class = "msj<?php echo $class; ?>"  >
                    <div class="mu_mensaje ">
                        ...
                        <div class="mu_msg_texto">
                            <p>
                               <b><?php echo $_mensajes[$i]["nombre_usuario_publica"];?></b> <?php echo " ".$lang_mural_usuario_dice.': '.enlazarURLs($_mensajes[$i]["mensaje"]);?>
                            </p>
                            <div id= "time" class="mu_msg_datos">
                                ...
                                if($usuario_gusta_mensaje<1){
                                    echo "<button  class = \"mu_megusta_msj_boton\" id = \"mu_gusta".$id_mensaje_actual."\">".$lang_mural_usuario_megusta."</button> ";
                                }
                                else{
                                    echo "<button class = \"mu_megusta_msj_boton\" id = \"mu_nogusta".$id_mensaje_actual."\">".$lang_mural_usuario_ya_no_megusta. "</button> ";
                                }
                                ?>
                                </div>
                                <?php
                            ...
                            <div class ="mu_comentar_mensaje">
                                <a class ="mu_boton_comentar" id ="<?php echo$_mensajes[$i]["id_mensaje"];?>" href="#"><?php echo $lang_mural_usuario_responder;?></a>
                            </div>
                            <?php
                            }
                            ?>
                    ...
                    <div id = "mu_responder_msj<?php echo $_mensajes[$i]["id_mensaje"];?>">
                        ...
                        <div class='mu_panel' id="mu_panel<?php echo $_mensajes[$i]["id_mensaje"]; ?>">
                            <form action="" method="post" name="<?php echo $_mensajes[$i]["id"]; ?>">
                                ...
                                <input type="submit" value="<?php echo $lang_mural_usuario_responder;?> "  class="mu_boton_enviar" id="mu_boton<?php echo $_mensajes[$i]["id_mensaje"]; ?>" name="<?php echo $_mensajes[$i]["id_mensaje"]; ?>" />
                            </form>
                        </div>
                    </div>
                    <?php
                    ...
                    if($_mensajes_en_respuesta_resumen[$j]){
                        ...
                        ?>
                        <div class ="mu_ver_comentarios_mensaje" id="mu_ver_comentarios_mensaje_modal<?php echo $_mensajes[$i]["id_mensaje"];?>">
                                ...
                                <button class ="mu_boton_ver_comentarios" id ="mu_ver_comentarios_modal<?php echo$_mensajes[$i]["id_mensaje"];?>" href= "#"> <?php echo $lang_comentar_ver1." ".$num_mensajes_en_respuesta." ".$lang_comentar_respuestas ;?></button>
                        </div>
                        <div class ="mu_ocultar_comentarios_mensaje" id="mu_ocultar_comentarios_mensaje_modal<?php echo $_mensajes[$i]["id_mensaje"];?>">
                            <img src="<?php echo $config_ruta_img; ?>comentar.gif" title ="<?php echo $lang_comentar_ver_todos;?>" alt="<?php echo $lang_comentar_ver_todos; ?>"/>
                            <button class ="mu_boton_ocultar_comentarios" id ="mu_ocultar_comentarios_modal<?php echo$_mensajes[$i]["id_mensaje"];?>" href= "#"> <?php echo $lang_comentar_ocultar." ".$num_mensajes_en_respuesta." ".$lang_comentar_respuestas ;?></button>
                        </div>
                        <?php
                        }
                        ?>
                                    ...
                                    <li class="mu_listado_respuestas">
                                        <div  class="mu_respuesta_mensaje">
                                            ...
                                            <div  class="mu_respuesta_msg_texto">
                                                <p>
                                                    <?php echo $_mensajes_en_respuesta_resumen[$j]["nombre"];?> <?php echo " ".$lang_mural_usuario_ult_msj_modal_dice; ?>:
                    ...
                    <div id = "mu_responder_msj_final<?php echo $_mensajes[$i]["id_mensaje"];?>">
                        ...
                        <div class='mu_panel_final' id="mu_panel_final<?php echo $_mensajes[$i]["id_mensaje"]; ?>">
                            <form action="" method="post" name="<?php echo $_mensajes[$i]["id"]; ?>">
                                ...
                                <input type="submit" value="<?php echo $lang_mural_usuario_responder;?>"  class="mu_boton_enviar_final" id="mu_boton_final<?php echo $_mensajes[$i]["id_mensaje"]; ?>" name="<?php echo $_mensajes[$i]["id_mensaje"]; ?>" />
                            </form>
                        </div>
                    </div>
                    <?php
                        ...
                        <div class="mu_mensaje ">
                            ...
                            <div class="mu_msg_texto">
                                <p>
                                    ...
                                    <b> <?php echo $_mensajes[$i]["nombre_usuario_publica"];?></b> <?php echo $lang_mural_usuario_ver_entre_muros1.' ';?><a id="mu_ver_mensaje_modal<?php echo $_mensajes[$i]["id_mensaje"];?>" href="mural_usuario_ver_msj_entre_muros.php?"><?php echo $lang_mural_usuario_ver_entre_muros2.' ';?></a> <?php echo $lang_mural_usuario_ver_entre_muros3.' ';?>
                                    <b><?php echo $_mensajes[$i]["nombre_usuario_dueno"];?></b>
                                </p>
                            </div>
                            <div id= "time" class="mu_msg_datos">
                                <?php echo relativeTime($_mensajes[$i]["fecha"], $rt_fecha_sin_formato, $rt_periodos, $rt_tiempo, $rt_plurales);?>
           ...
           $i++;
            ...
            <div class="mu_ver_mas" >
                <button class="mu_boton_ver_mas" id="ver_mas_modal<?php echo $class;?>" href="#"><?php echo $lang_mural_usuario_ver_mas;?></button>
            </div>
            <?php
            }
    }
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(".mu_boton_enviar").click(function(){
            ...
            if(test=='')
            {
                alert("<?php echo $lang_mural_usuario_ult_msj_modal_ingresa_comentario; ?>");
            }
            else
            {
                $("#mu_msj"+Id).show();
                $("#mu_msj"+Id).fadeIn(400).html('<img src="<?php echo $config_ruta_img;?>cargando_respuesta_mensaje.gif" align="absmiddle" > <?php echo $lang_mural_usuario_ult_msj_modal_cargando; ?>.....');
                $.ajax({
                    type: "POST",
        ...
        $(".mu_boton_enviar_final").click(function(){
            ...
            else
            {
                ...
                $("#mu_msj_final"+Id).fadeIn(400).html('<img src="<?php echo $config_ruta_img;?>cargando_respuesta_mensaje.gif" align="absmiddle" > <?php echo $lang_mural_usuario_ult_msj_modal_cargando; ?>.....');
                $.ajax({
                    type: "POST",
                    url: "mural_usuario_enviar_post.php",
                    data: dataString,
...
//       });
        ...
        while($num_grupos < $grupos_msj){
            ?>
                    $("#ver_mas_modal<?php echo $num_grupos+1; ?>").hide();
                    $('.msj<?php echo $num_grupos; ?>').hide();
                    $('#ver_mas_modal<?php echo $num_grupos; ?>').click(function(){
                        //alert("me hicieron click");
                        $('.msj<?php echo $num_grupos; ?>').addClass('mu_mensaje_completo');
                        $('.msj<?php echo $num_grupos; ?>').show();
                        $('#ver_mas_modal<?php echo $num_grupos; ?>').hide();
                        $('#ver_mas_modal<?php echo $num_grupos+1; ?>').show();
                    });
        ...
        ?>
            ...
            $('#mu_ver_comentarios_modal<?php echo $_mensajes[$num]["id_mensaje"]; ?>').click(function(){
                ...
                $.get(url_respuestas, function(data) {
                    ...
                    $("#mu_ver_comentarios_mensaje_modal<?php echo $_mensajes[$num]["id_mensaje"];?>").hide();
                    ...
                    $('#mu_ocultar_comentarios_mensaje_modal<?php echo $_mensajes[$num]["id_mensaje"]; ?>').show();
                });
            });
            $('#mu_ocultar_comentarios_modal<?php echo $_mensajes[$num]["id_mensaje"]; ?>').click(function(){
                $('#mu_ocultar_comentarios_mensaje_modal<?php echo $_mensajes[$num]["id_mensaje"]; ?>').hide();
                ...
                $("#mu_ver_comentarios_mensaje_modal<?php echo $_mensajes[$num]["id_mensaje"];?>").show();
                    ...
                    var $linkc = $(this);
                     $linkc.click(function() {
                        ...
                        .dialog({
                            ...
                            modal: true,
                            buttons: {
                                "<?php echo $lang_mural_usuario_ult_msj_modal_cerrar; ?>": function() {
                                $(this).dialog("close");
                                }
                            },
                            close: function(ev, ui) {
           ...
           $('#mu_ver_mensaje_modal<?php echo $_mensajes[$num]["id_mensaje"]; ?>').each(function() {
                    var $linkc = $(this);
                     $linkc.click(function() {
                        var $dialog = $('<div></div>')
                        .load($linkc.attr('href')+'id_mensaje=<?php echo $_mensajes[$num]["id_mensaje"]; ?>')
                        .dialog({
                            autoOpen: false,
                            title: '<?php echo $lang_usuarios_gusta_msj_titulo_ventana;?>',
                            width: 400,
