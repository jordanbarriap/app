    ...
    <div class="grid_11" id="header_dd">
        ...
        <div id="nombre_dd">
            <h1 class="nombre_dd"><?php echo "<span class=\"gris_claro\">".$lang_estas_ejecutando."</span>: ".$datos_experiencia["nombre_dd"];?>
                ...
                ?>
                    <img src="<?php echo $config_ruta_img_herramientas."no_herramienta.png";?>" alt="<?php echo $lang_exp_plataforma_kellu;?>" title="<?php echo $lang_exp_plataforma_kellu;?>"></img>
                <?php
                }
                ?> 
            </h1>
...
<div class="container_16">
    <div id="tabs" class="grid_16">
        <ul>
<?php
$tablink_lista_etapas = "<li><a id='tab_gestion_avance' href=\"exp_lista_etapas.php?codexp=".$id_experiencia."\" name='Gestión de Avance Experiencia ".$id_experiencia."'>".$lang_tab_gestion."</a></li>";
$tablink_bitacora = "<li><a id='tab_bitacora' href=\"exp_bitacora.php?codexp=".$id_experiencia."&et_exp=".$etiqueta_exp."&et_gemela=".$etiqueta_gemela."\" name='Bitácora Experiencia ".$id_experiencia."'>".$lang_tab_bitacora."</a></li>";
$tablink_detalles = "<li><a href=\"exp_detalles.php?coddd=".$id_dd."&codexp=".$id_experiencia."&et_exp=".$etiqueta_exp."&et_gemela=".$etiqueta_gemela."\" name='Resumen Diseño Experiencia ".$id_experiencia."'>".$lang_tab_detalles."</a></li>";
...
//$tablink_revisionpares = "<li><a href=\"revpares/exp_revisionpares.php?codexp=".$id_experiencia."&et_exp=".$etiqueta_exp."&et_gemela=".$etiqueta_gemela."&es_estudiante=".$es_estudiante."\" name='Trabajos Vista Estudiante Experiencia ".$id_experiencia."'>".$lang_tab_trabajos."</a></li>";
//$tablink_revisionpares_profesor = "<li><a href=\"revpares/exp_revisionpares_profesor.php?codexp=".$id_experiencia."&et_exp=".$etiqueta_exp."&et_gemela=".$etiqueta_gemela."&es_estudiante=".$es_estudiante."\" name='Trabajos Vista Profesor Experiencia ".$id_experiencia."'>".$lang_tab_trabajos."</a></li>";
...
$tablink_administracion="<li><a id='tab_administracion_exp' href=\"administrador_experiencia.php?codeexp=".$id_experiencia."\" name='Administración Experiencia ".$id_experiencia."'>".$lang_exp_admin."</a></li>";
$tablink_muro_diseno="<li class= \"md_tab_kellu\"><a  href=\"mural_diseno.php?codexp=".$id_experiencia."&coddd=".$id_dd."&id_actividad=".$id_actividad."\" name= 'Kellu-Muro Experiencia ".$id_experiencia."'>".$lang_exp_kellu_muro."</a></li>";
$tablink_portafolio = "<li><a href=\"portafolio/vision_estudiante/portafolio_estudiante.php?codexp=".$id_experiencia."\">".$lang_tab_portafolio."</a></li>";
$tablink_portafolio_profesor = "<li><div><div id='nombre_pestana' style='display: inline;'><a href=\"portafolio/vision_profesor/portafolio_profesor.php?codexp=".$id_experiencia."\">".$lang_tab_portafolio."</a></li>";

if ($es_estudiante){
    echo "            ".$tablink_bitacora."\n\r";
    echo "            ".$tablink_lista_etapas."\n\r";
    //echo "            ".$tablink_revisionpares."\n\r";
    echo "            ".$tablink_portafolio."\n\r";
}
else{
    if($es_observador){
        echo "            ".$tablink_lista_etapas."\n\r";
        ...
        echo "            ".$tablink_portafolio_profesor."\n\r";
    }
    else{
        echo "            ".$tablink_lista_etapas."\n\r";
        echo "            ".$tablink_bitacora."\n\r";
