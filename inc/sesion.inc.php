...
function crearSesion($id_usuario, $usuario, $inscribe_diseno, $nombre, $foto, $email,$mostrar_correo,$mostrar_fecha, $administrador,$id_sesion) {
    ...
    //Codigo agregador por Jordan el 31-10-14
    $_SESSION["id_sesion"]=$id_sesion;
    $_SESSION["salir_navegador"]=null;
...
function eliminarSesion() {
    ...
    unset($_SESSION["salir_navegador"]);
}
...
//Código agregado por Jordan Barría el 02-11-14
function salirActualPaginaKelluwen() {
    if (existeSesion()) $_SESSION["salir_navegador"]=date("Y-n-j H:i:s");
}

function verificaSalirNavegador(){
    return isset($_SESSION["salir_navegador"]);
}
