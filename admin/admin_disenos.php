    ...
    <div id ="admin_contenido">
        <div class="grid_4">
                ...
                <ul class="exp_menu">
                    ...
                    ?>
                        ...
                        <a class="enlace_menu" id="agno_<?php echo $agno[$i]; ?>">
                            <?php echo $lang_admin_agno.' '.$agno[$i]; ?>
                        </a>
                    </li>
                    <?php
                        }
            ...
            <div class="grid_12">
                <div class="admin_volver_administrador">
                    ...
                    <input class="admin_exp_boton_volver_inicio" type="button" value="<?php echo $lang_admin_archivos_ej; ?>" onclick="javascript: mostrarDivArchEjemplo();">
                </div>
                ...
                <div class="admin_filtros_sector">
                    <ul class="admin_bloque_filtros_sector">
                        ...
                        <li class="admin_li_filtro_sector"><a class="admin_filtro_sector" id = "admin_filtro_tecnologia"><?php echo $lang_crear_diseno_admin_tecnologia; ?></a> </li>
        ...
        <div id="admin_arch_ejemplo">
            ...
            <div class="grid_12">
                <div class="admin_volver_administrador">
                    <input class="admin_exp_boton_volver_inicio" type="button" value="<?php echo $lang_crear_diseno_admin_volver2; ?>" onclick="javascript: volverAdminInicio();">
                    <input class="admin_exp_boton_volver_inicio" type="button" value="<?php echo $lang_admin_disenos_didacticos; ?>" onclick="javascript: mostrarDivContenido();">
                </div>
                <div class="clear"></div>
            </div>
            <div class="clear"></div>
