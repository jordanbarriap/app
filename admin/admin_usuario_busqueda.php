...
?>
    ...
    <form id="form_admin_busqueda" method="post" action="">
        <div id="caja_form_admin_busqueda">
            <label><?php echo $lang_registro_nombre." o ".$lang_registro_apellido." :";?></label>
            <input tabindex="1" type="text" maxlenght="20" size="20" id="fr_admin_busqueda_nombre"  name="fr_admin_busqueda_nombre" />
            <label  class="sugerencia" id="admin_sugerencia_nombre"><?php echo $lang_admin_nombre_o_apellido; ?></label>
            <div class="clear"></div>
    ...
    $(document).ready(function(){
        ...
        $("#form_admin_busqueda").validate({
            ...
            submitHandler: function() {
                url = 'admin/admin_usuarios_listado.php?modo=3';
