...
<div id="crear_diseno">
    <div id="datos_diseno_admin">
        <div id="formulario_crear_diseno">
            ...
            <div id="mascara_admin" style="left: 200px;"></div>
        </div>
    </div>
</div>
    ...
    function enviarMsgAdmin(idDiseno, texto_diseno){
        ...
        $.get('./taller_dd/tdd_agregarMsgAdmin.php?id_diseno='+idDiseno+"&texto_diseno="+texto_diseno, function(data) {
            if(data == 'true'){
                ...
                msg = "Tu mensaje no se pudo enviar, intenta mas tarde.";
            }
...
//        document.getElementById('ayuda_d_admin').style.left = (posiciones[0]+400-anc)+"px";
        document.getElementById('ayuda_d_admin').style.left = "666px";
        document.getElementById('ayuda_d_admin').style.top = (posiciones[1]-55)+"px";
        ...
        document.getElementById('ayuda_di_admin').style.left = "235px";
        document.getElementById('ayuda_di_admin').style.top = (posiciones[1]-170)+"px";
    ...
    function deshabilitarEdicionDiseno(){
        ...
        $('#editar_diseno_admin').attr('value','Editar');
