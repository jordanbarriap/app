...
$conexion= dbConectarMySQL($config_host_bd, $config_usuario_bd, $config_password_bd, $config_bd);    
    switch($mover){
        ...
        case "arriba":
            ...
            break;
        case "izquierda":
            mueveIzquierdaActividadFuncion($id_actividad, $actividad_orden, $id_etapa, $orden_etapa, $conexion);
            $resultado= 'true';
            break;
        case "derecha":
            moverDerechaActividadFuncion($id_actividad, $actividad_orden, $id_etapa, $orden_etapa, $conexion);
            $resultado= 'true';
            break;
    }       
