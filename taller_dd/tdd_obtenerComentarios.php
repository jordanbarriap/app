<?php
    ...
    $_comentarios = obtenerComentariosFuncion($id_diseno, $tipo, $end, $conexion);
...
?>
        <div class="tdd_verMasComentarios" onClick="verMasComentarios(<?php echo $id_diseno; ?>)"><?php echo $lang_crear_diseno_coment_vermas; ?></div>
<?php            
       }
