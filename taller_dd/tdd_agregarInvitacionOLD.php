<?php
    ...
    $mensaje_correo = $_SESSION["klwn_nombre"]." te ha invitado a participar de la creación del diseño ".$texto_diseno.". Para aceptar la invitación, debes revisar tu muro.";
